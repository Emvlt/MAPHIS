...
class Edge():
    ...
    def triangular_inequality(self, other_edge_0, other_edge_1):
        if self.length <other_edge_0.length + other_edge_1.length  and (other_edge_0.length < self.length and other_edge_1.length < self.length):
            return True
        return False
